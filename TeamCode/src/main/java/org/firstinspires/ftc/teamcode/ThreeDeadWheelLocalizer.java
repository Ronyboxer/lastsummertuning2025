...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =1565.9335993850461; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1922.44303570985; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1231.3951407727911; // x position of the perpendicular encoder (in tick units)
    }
